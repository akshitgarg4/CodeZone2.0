          ...
          <TableBody>
            {data.map((row, count) => (
              <StyledTableRow key={count}>
                ...
                <StyledTableCell align="right">{row["SID"][0]}</StyledTableCell>
                <StyledTableCell align="right">
                  {row["students"][1]}
                </StyledTableCell>
                <StyledTableCell align="right">{row["SID"][1]}</StyledTableCell>
                <StyledTableCell align="right">
                  {row["students"][2]}
                </StyledTableCell>
                <StyledTableCell align="right">{row["SID"][2]}</StyledTableCell>
                <StyledTableCell align="right">
                  {row["students"][3]}
                </StyledTableCell>
                <StyledTableCell align="right">{row["SID"][3]}</StyledTableCell>
                <StyledTableCell align="right">
                  {row["students"][4]}
                </StyledTableCell>
                <StyledTableCell align="right">{row["SID"][4]}</StyledTableCell>
                <StyledTableCell align="right">
                  {row["mentor_name"]}
                </StyledTableCell>
              </StyledTableRow>
